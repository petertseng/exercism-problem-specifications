...
def valid_luhn?(input, map_digit = method(:map_luhn_digit), modulus: 10)
...
multi_verify(json['cases'], property: 'valid', implementations: [
  ...
  {
    # https://github.com/exercism/problem-specifications/pull/1635
    name: 'evens',
    should_fail: true,
    f: ->(i, _) { valid_luhn?(i['value'], modulus: 2) },
  },
  {
